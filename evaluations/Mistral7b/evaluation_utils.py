...
def execute_sql(predicted_sql, ground_truth, db_path, sql_dialect, calculate_func, idx):
    ...
    predicted_res = [(idx,) + row for row in predicted_res]
    ground_truth_res = [(idx,) + row for row in ground_truth_res]
    res = calculate_func(predicted_res, ground_truth_res, return_details=True)
    return res
